            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="file" id="photo_two" name="photo_two">
                  </div>

                  <div class="col-sm-5">
                    <input type="file" id="photo_three" name="photo_three">
                  </div>

                  <div class="col-sm-5">
                    <input type="file" id="photo_four" name="photo_four">
                  </div>
                </div>
                <div class="form-group">
                <label for="photo" class="col-sm-1 control-label">BLOB</label>
                  <div class="col-sm-5">
                    <input type="file" id="photo_blob" name="photo_blob">
                  </div>
                </div>
                <p><b>Description</b></p>
                <div class="form-group">
